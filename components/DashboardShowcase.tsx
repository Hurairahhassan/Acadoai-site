  ...
  <div className="flex h-full bg-slate-50 text-slate-800 font-sans overflow-hidden rounded-xl border border-slate-200 shadow-2xl">
    ...
    <div className="w-64 bg-white border-r border-slate-200 flex flex-col hidden lg:flex flex-shrink-0">
      ...
      <div className="p-4 space-y-1 text-sm font-medium overflow-y-auto flex-1">
        <div className="text-blue-600 bg-blue-50 px-3 py-2 rounded-md mb-2">
          Admin Mode
        </div>
        {[
          ...
          <div
            key={i}
            className={`flex items-center gap-3 px-3 py-2 rounded-md cursor-pointer transition-colors ${i === 0 ? "text-blue-600 bg-blue-50" : "text-slate-500 hover:bg-slate-50"}`}
          >
            {item.icon}
      ...
      <main className="flex-1 p-6 overflow-y-auto no-scrollbar">
        ...
        <div className="bg-blue-600 text-white p-6 rounded-xl mb-6 shadow-lg">
          ...
          <p className="text-blue-100 opacity-90">
            Overview of system performance, users, and activities
          </p>
        </div>
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-1">
          {["Overview", "Students", "Teachers", "Classes"].map((tab, i) => (
            <button
              key={tab}
              className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all whitespace-nowrap ${i === 0 ? "bg-white shadow-sm text-slate-900" : "text-slate-500 hover:bg-slate-200"}`}
            >
              {tab}
            </button>
          ))}
          ...
          {[
            ...
            >
              ...
              <div className="text-3xl font-bold text-slate-900 mb-1">
                {i < 2 ? card.val : card.displayVal}
              </div>
              {i < 2 && (
                <div className="text-sm text-slate-400 absolute opacity-0 group-hover:opacity-100">
                  Loading...
                </div>
              )}
              ...
              {i < 2 ? (
                ...
                <div
                  className={`text-xs ${i === 3 ? "text-slate-500" : "text-green-600"} font-medium mt-1`}
                >
                  {card.sub}
                </div>
              )}
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <div className="xl:col-span-2 bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <h3 className="font-bold text-slate-800 flex items-center gap-2">
                <TrendingUp size={18} className="text-blue-600" /> Student
                Performance Trends
              </h3>
            </div>
            <div className="space-y-5">
              {[
                ...
                <div key={d.mon} className="flex items-center gap-4">
                  <span className="text-xs text-slate-500 w-8 font-medium">
                    {d.mon}
                  </span>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
            <h3 className="font-bold mb-4 text-slate-800 flex items-center gap-2">
              <TrendingUp size={18} className="text-purple-600" /> Teacher
              Activity Overview
            </h3>
            <div className="space-y-0 text-sm">
              ...
              {[
                ...
                <div
                  key={i}
                  className="grid grid-cols-4 py-4 border-b border-slate-50 items-center hover:bg-slate-50 transition-colors"
                >
  ...
  <div className="flex h-full bg-slate-50 text-slate-800 font-sans overflow-hidden rounded-xl border border-slate-200 shadow-2xl">
    ...
    <div className="w-64 bg-white border-r border-slate-200 hidden lg:flex flex-col flex-shrink-0">
      <div className="p-5 flex items-center gap-2 h-16 border-b border-slate-50">
        <div className="bg-blue-600 text-white p-1.5 rounded text-xs font-bold">
          T
        </div>
      ...
      <div className="p-4 space-y-1 text-sm font-medium">
        {[
          ...
          <div
            key={i}
            className={`px-3 py-2.5 rounded-lg flex items-center gap-3 cursor-pointer transition-colors ${i === 0 ? "bg-blue-50 text-blue-600 font-medium" : "text-slate-500 hover:bg-slate-50"}`}
          >
        ...
        <div className="flex-1 space-y-6 min-w-0">
          ...
          <div className="bg-blue-600 text-white p-6 rounded-xl shadow-md flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex gap-2 flex-wrap">
              <button className="px-3 py-2 bg-white/20 rounded-lg text-sm hover:bg-white/30 transition font-medium flex items-center gap-2">
                <Calendar size={14} /> View Schedule
              </button>
              <button className="px-3 py-2 bg-white/20 rounded-lg text-sm hover:bg-white/30 transition font-medium flex items-center gap-2">
                <CheckSquare size={14} /> Assignments
              </button>
              <button className="px-3 py-2 bg-white/20 rounded-lg text-sm hover:bg-white/30 transition font-medium flex items-center gap-2">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold flex items-center gap-2">
                <BookOpen size={18} className="text-blue-600" /> Today's Classes
              </h3>
              <span className="text-blue-600 text-xs font-bold cursor-pointer hover:underline">
                View All &gt;
              </span>
            </div>
            <div className="space-y-3">
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-100 hover:bg-slate-100 transition-colors cursor-pointer">
                <div className="flex justify-between mb-1">
                  ...
                  <div className="flex items-center gap-1 text-xs text-slate-500">
                    <Users size={14} /> 32 students
                  </div>
                </div>
                <div className="flex justify-between text-sm text-slate-500 mt-2">
                  <span className="flex items-center gap-1">
                    <Calendar size={14} /> 09:00 AM - 10:30 AM • Room A101
                  </span>
              ...
              <div className="p-4 bg-slate-50 rounded-lg border border-slate-100 hover:bg-slate-100 transition-colors cursor-pointer">
                <div className="flex justify-between mb-1">
                  ...
                  <div className="flex items-center gap-1 text-xs text-slate-500">
                    <Users size={14} /> 20 students
                  </div>
                </div>
                <div className="flex justify-between text-sm text-slate-500 mt-2">
                  <span className="flex items-center gap-1">
                    <Calendar size={14} /> 04:00 PM - 05:30 PM • Lab B201
                  </span>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold flex items-center gap-2 text-slate-800">
                <CheckSquare size={18} className="text-purple-600" /> Upcoming
                Assignments & Deadlines
              </h3>
              <span className="text-purple-600 text-xs font-bold cursor-pointer hover:underline">
                View All &gt;
              </span>
            </div>
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="text-xs bg-slate-200 px-2 py-1 rounded mb-1 inline-block font-medium">
                      Due: {a.due}
                    </div>
                    <div className="text-xs text-slate-500 mt-1">
                      Submissions: {a.sub}
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm h-full">
            ...
            <div className="space-y-4">
              <div className="flex gap-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-800 leading-tight">
                    Department meeting tomorrow at 3:00 PM
                  </p>
              ...
              <div className="flex gap-3 p-3 bg-green-50 rounded-lg border border-green-100">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-800 leading-tight">
                    Sarah Johnson submitted Math Assignment #3
                  </p>
              ...
              <div className="flex gap-3 p-3 bg-red-50 rounded-lg border border-red-100">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <p className="text-sm font-bold text-slate-800 leading-tight">
                      Physics 101 had below 70% attendance today
                    </p>
            ...
            <div className="mt-6 text-center">
              <span className="text-blue-600 text-sm font-bold cursor-pointer hover:underline">
                View All Alerts
              </span>
            </div>
          </div>
  ...
  <div className="flex h-full bg-white text-slate-800 font-sans overflow-hidden rounded-xl border border-slate-200 shadow-2xl">
    ...
    <div className="w-64 bg-white border-r border-slate-200 hidden lg:flex flex-col flex-shrink-0">
      ...
      <div className="p-4 space-y-1 text-sm font-medium text-slate-600 overflow-y-auto flex-1">
        {["Dashboard", "Class", "Class Materials", "Tests", "Assignments"].map(
          (item, i) => (
            <div
              key={i}
              className={`px-3 py-2.5 rounded-md cursor-pointer flex items-center gap-3 ${i === 0 ? "text-slate-800 font-bold" : "hover:bg-slate-50"}`}
            >
              <LayoutDashboard
                size={18}
                className={i === 0 ? "text-slate-800" : "text-slate-400"}
              />
              {item}
            </div>
          ),
        ...
        <div className="my-2 px-3 py-2 text-slate-400 text-xs font-bold uppercase">
          AI Tools
        </div>
        ...
        {[
          ...
          <div
            key={i}
            className={`px-3 py-2 rounded-md cursor-pointer flex items-center justify-between hover:bg-slate-50`}
          >
        ...
        <div className="my-2 pt-2 border-t border-slate-100">
          {["Teacher Appointments", "Admission Letter", "Pay Fees"].map(
            (item) => (
              <div
                key={item}
                className="px-3 py-2 hover:bg-slate-50 rounded-md cursor-pointer flex items-center gap-3"
              >
      ...
      <main className="flex-1 p-6 overflow-y-auto no-scrollbar">
        ...
        <div className="bg-blue-600 text-white p-8 rounded-xl mb-6 shadow-lg relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 font-medium opacity-90">
              Track your academic progress, attendance, test scores, and class
              activities
            </p>
          </div>
          {/* Decoration */}
        ...
        <div className="flex bg-white p-1.5 rounded-xl shadow-sm border border-slate-200 mb-6 w-full overflow-x-auto">
          {[
            ...
            <button
              key={t}
              className={`flex-1 min-w-[100px] py-2.5 text-sm font-medium rounded-lg transition-all ${i === 0 ? "bg-white shadow-sm text-slate-900 border border-slate-100" : "text-slate-500 hover:bg-slate-50"}`}
            >
              {i === 0 && (
                <LayoutDashboard
                  size={16}
          ...
          {[
            {
              l: "Overall GPA",
              v: "3.8",
              i: <Award className="text-orange-600" />,
              bg: "bg-orange-50",
            },
            {
              l: "Attendance",
              v: "92%",
              i: <Calendar className="text-green-600" />,
              bg: "bg-green-50",
            },
            {
              l: "Tasks Completed",
              v: "45/50",
              i: <CheckSquare className="text-blue-600" />,
              bg: "bg-blue-50",
            },
            {
              l: "Class Rank",
              v: "5 / 32",
              i: <Award className="text-yellow-600" />,
              bg: "bg-yellow-50",
            },
          ].map((s, i) => (
            <div
              key={i}
              className="bg-white p-5 rounded-xl shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow"
            >
              <div
                className={`w-12 h-12 rounded-full ${s.bg} flex items-center justify-center`}
              >
                {s.i}
              </div>
              <div>
            ...
            <div className="h-56 w-full relative flex items-end">
              ...
              <div className="ml-8 flex-1 h-full relative overflow-hidden">
                ...
                >
                  ...
                  <path
                    d="M0,80 C80,60 160,90 240,85 C320,80 400,40 480,35 C560,30 640,20 800,10 L800,200 L0,200 Z"
                    fill="url(#grad1)"
                  />
                  <path
                    d="M0,80 C80,60 160,90 240,85 C320,80 400,40 480,35 C560,30 640,20 800,10"
                    stroke="#4f46e5"
                    strokeWidth="3"
                    fill="none"
                    strokeLinecap="round"
              ...
              <div className="flex flex-col gap-3 mt-6 w-full px-4">
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2 text-slate-600">
                    <div className="w-3 h-3 bg-blue-600 rounded-sm" /> Present
                  </div>
                  <span className="font-bold text-blue-600">85%</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2 text-slate-600">
                    <div className="w-3 h-3 bg-orange-500 rounded-sm" /> Late
                  </div>
                  <span className="font-bold text-orange-500">7%</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2 text-slate-600">
                    <div className="w-3 h-3 bg-red-500 rounded-sm" /> Absent
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Tailored interfaces for Admins, Teachers, and Students ensure
            everyone has exactly the tools they need.
          </p>
        </div>
